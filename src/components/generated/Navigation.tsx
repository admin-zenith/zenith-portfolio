...
export const Navigation = ({
  ...
  return <SortableContainer dndKitId="9b094e00-cae3-4458-ab4e-9640a0fc1045" containerType="regular" prevTag="motion.nav" initial={{
    y: -100,
    opacity: 0
  }} animate={{
    y: 0,
    ...
    damping: 20
      ...
      <SortableContainer dndKitId="226e64e0-a6db-4154-adcc-c47b84d945a8" containerType="regular" prevTag="div" className="bg-[#252525]/70 backdrop-blur-2xl border border-white/10 rounded-full shadow-2xl shadow-black/20 px-8 py-3" data-magicpath-id="1" data-magicpath-path="Navigation.tsx">
        <SortableContainer dndKitId="b1956773-13a0-428c-a722-9ee14ab7ac1d" containerType="regular" prevTag="div" className="flex items-center justify-between gap-8" data-magicpath-id="2" data-magicpath-path="Navigation.tsx">
          {/* Logo */}
          <SortableContainer dndKitId="f3f3569b-27a4-4d72-9b82-3b26fcb03a61" containerType="regular" prevTag="motion.div" whileHover={{
          scale: 1.05
        }} whileTap={{
          scale: 0.95
            ...
            <SortableContainer dndKitId="c9d33c8d-d7ad-4ab8-a6e1-31c7f3457c77" containerType="regular" prevTag="div" className="flex items-baseline" data-magicpath-id="5" data-magicpath-path="Navigation.tsx">
          ...
          {/* Nav Links */}
          <SortableContainer dndKitId="eabde345-8895-4a15-b12b-5fb6b8906f45" containerType="collection" prevTag="motion.div" className="hidden md:flex items-center space-x-1" variants={containerVariants} initial="hidden" animate="visible" data-magicpath-id="8" data-magicpath-path="Navigation.tsx">
