...
export const Navigation = ({
  ...
  return <SortableContainer dndKitId="73fa609b-bba7-4e4d-a5db-0d4003fd0b7e" containerType="regular" prevTag="motion.nav" initial={{
    y: -100,
    opacity: 0
  }} animate={{
    y: 0,
    ...
    damping: 20
      ...
      <SortableContainer dndKitId="a99fcb0e-4e26-47e9-af4e-6cc922f6f731" containerType="regular" prevTag="div" className="bg-[#252525]/70 backdrop-blur-2xl border border-white/10 rounded-full shadow-2xl shadow-black/20 px-8 py-3" data-magicpath-id="1" data-magicpath-path="Navigation.tsx">
        <SortableContainer dndKitId="060ffc92-fc61-484e-98b7-98a83d9aff7e" containerType="regular" prevTag="div" className="flex items-center justify-between gap-8" data-magicpath-id="2" data-magicpath-path="Navigation.tsx">
          {/* Logo */}
          <SortableContainer dndKitId="7147d968-ca24-41b7-ade3-565038082e8a" containerType="regular" prevTag="motion.div" whileHover={{
          scale: 1.05
        }} whileTap={{
          scale: 0.95
            ...
            <SortableContainer dndKitId="684a122a-0255-4fad-a000-0d70d01137e8" containerType="regular" prevTag="div" className="flex items-baseline" data-magicpath-id="5" data-magicpath-path="Navigation.tsx">
          ...
          {/* Nav Links */}
          <SortableContainer dndKitId="085c9669-f9f2-4191-bbfe-cb6eb03a5e18" containerType="collection" prevTag="motion.div" className="hidden md:flex items-center space-x-1" variants={containerVariants} initial="hidden" animate="visible" data-magicpath-id="8" data-magicpath-path="Navigation.tsx">
