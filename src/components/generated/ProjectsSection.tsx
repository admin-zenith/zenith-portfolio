      ...
      <motion.div className="grid md:grid-cols-3 gap-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{
        ...
        {RECENT_PROJECTS.map((project, index) => <motion.div key={project.title} initial={{
          ...
          <div className="relative p-8 flex flex-col h-full">
            ...
            {/* View Project Link */}
            <motion.div onClick={() => handleClick(project)} className="flex items-center gap-2 text-sm font-semibold text-[#c2f12d] opacity-0 group-hover:opacity-100 transition-opacity duration-300" whileHover={{
              x: 4
            }}>
