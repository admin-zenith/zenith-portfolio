...
export const TeamSection = () => {
  return <SortableContainer dndKitId="b987b94c-167f-463a-aacd-302d5fd14ee2" containerType="regular" prevTag="section" id="team" className="relative py-32 px-6 bg-gradient-to-b from-white to-slate-50" data-magicpath-id="0" data-magicpath-path="TeamSection.tsx">
      <SortableContainer dndKitId="14bf219e-be29-41e1-9dcc-7c76b9b0b4df" containerType="regular" prevTag="div" className="max-w-6xl mx-auto" data-magicpath-id="1" data-magicpath-path="TeamSection.tsx">
        <SortableContainer dndKitId="603c87e9-17df-410e-8d9e-2f8723465dab" containerType="regular" prevTag="motion.div" initial={{
        opacity: 0,
        y: 30
      }} whileInView={{
        opacity: 1,
        ...
        once: true
          ...
          <SortableContainer dndKitId="a80541c5-a1fc-4aea-8245-a8c3f96635ba" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          scale: 0.9
        }} whileInView={{
          opacity: 1,
          ...
          type: 'spring'
            ...
            <SortableContainer dndKitId="293b8b8d-3d50-4c25-8e3d-93158885b989" containerType="regular" prevTag="motion.div" animate={{
            rotate: [0, 360]
          }} transition={{
            duration: 3,
            repeat: Infinity,
        ...
        <SortableContainer dndKitId="082a6b64-4007-48ba-92d5-cd339bb19b68" containerType="collection" prevTag="motion.div" className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{
        once: true,
        margin: '-100px'
