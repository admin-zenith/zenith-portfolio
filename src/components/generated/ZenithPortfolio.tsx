...
export const ZenithPortfolio = (props: ZenithPortfolioProps) => {
  ...
  return (
    <div className="min-h-screen bg-[#252525] text-white overflow-x-hidden">
      {/* Floating Particles */}
      <FloatingParticles />
          ...
          >
            {faqs.map((faq, index) => (
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:border-[#c2f12d]/30 transition-all duration-300"
              >
                <motion.button
                ...
                >
                  ...
                  >
                    {openFaq === index ? (
                      <ChevronUp className="w-6 h-6 flex-shrink-0 text-[#c2f12d]" />
                    ) : (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              >
                <a
                  href="https://calendly.com/zaballero-glenn-zenith-tech/zenith-project-discovery-call"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <MagneticButton className="px-10 py-5 bg-[#c2f12d] hover:bg-[#b0dc28] text-[#252525] rounded-2xl font-bold text-lg transition-all shadow-2xl">
                ...
                <MagneticButton
                  className="px-10 py-5 border-2 border-white/40 hover:border-white/60 hover:bg-white/10 text-white rounded-2xl font-bold text-lg transition-all backdrop-blur-xl"
